...
//cpu.EFLAGS.bits.CF=((~((op_dest->val>>31)^(op_src->val>>31)))==(result>>31));
...
cpu.EFLAGS.bits.ZF=(result==0);
cpu.EFLAGS.bits.OF =(!((op_dest->val>>31)^(op_src->val>>31)))&&((op_dest->val>>31)^(result>>31))&1;
if(((op_src->val>>31)&(op_dest->val>>31))==1)cpu.EFLAGS.bits.CF=1;
else if((((op_src->val>>31)^(op_dest->val>>31))==1)&&((result>>31)==0))cpu.EFLAGS.bits.CF=1;
else cpu.EFLAGS.bits.CF=0;
cpu.EFLAGS.bits.SF=(result>>31)&1;
